...
\${template3}├ \${template1}Input\${goto 125}\${color2}\${template2}${yamaha_data[1]} - \${template2}${yamaha_data[2]}
...
\${template3}├ \${template1}Pure Direct\${goto 125}\${color2}\${template2}${yamaha_data[6]}
