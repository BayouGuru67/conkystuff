...
local BAR_CONFIG = {
    {
        xb = 52, yb = 224, name = 'upspeedf', arg = 'enp7s0', max = 20000, nb_blocks = 42,
        cap = CAIRO_LINE_CAP_SQUARE, w = 9, h = 4, space = 1,
        warning = 75, alarm = 90,
        led_effect = true, led_alpha = 0.8, rotation = 90
    },
    {
        xb = 52, yb = 241, name = 'downspeedf', arg = 'enp7s0', max = 100000, nb_blocks = 42,
        cap = CAIRO_LINE_CAP_SQUARE, w = 9, h = 4, space = 1,
        warning = 75, alarm = 90,
        led_effect = true, led_alpha = 0.8, rotation = 90
    }
...
local BG_STRIPE = {start_x = 8, start_y = 270, pair_height = 34, total_width = 252}
