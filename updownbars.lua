...
-- Upload
cr = cairo_create(cs)
equalizer(cr, 88, 278, 'upspeedf', 'enp6s0', 20000, 71, CAIRO_LINE_CAP_SQUARE, 10, 2, 1, 0x606070, 1, 0x00ff0c, 1, 0xff0000, 1, 80, true, 1, true, 0xffff00, 1, 90)
cairo_destroy(cr)
-- Download
cr = cairo_create(cs)
equalizer(cr, 88, 296, 'downspeedf', 'enp6s0', 50000, 71, CAIRO_LINE_CAP_SQUARE, 10, 2, 1, 0x606070, 1, 0x00ff0c, 1, 0xff0000, 1, 80, true, 1, true, 0xffff00, 1, 90)
cairo_destroy(cr)
end
